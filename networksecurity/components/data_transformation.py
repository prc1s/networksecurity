...
from networksecurity.utils.main_utils.utils import save_numpy_array_data, save_pickle_object
...
class DataTransformation():
    ...
    def get_data_transformer_object(cls):
        logger.info("Started get_data_transformer_object Function At DataTransformation Class")
        try:
            imputer: KNNImputer = KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logger.info(f"Initiated KNNImputer With {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self):
        ...
        try:
            ...
            save_pickle_object(file_path=self.data_transformation_config.transformed_object_file_path,obj=preprocessor_object)
            
            save_pickle_object(file_path="final_models/preprocessor.pkl",obj=preprocessor_object)
